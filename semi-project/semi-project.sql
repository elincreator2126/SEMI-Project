...
insert into board (seq, title, contents, writer, password, viewcount) values(board_seq.nextval,'제목', '내용', 'elin', 9999, 0)
insert into board (seq, title, contents, writer, password, viewcount) values(board_seq.nextval,'현업자의 리뷰', '인재의 기술역량 잠재력 기술, 인재의 보완사항 작성', '현업자', 8888, 0)
